...
public class SQLUtils {
	...
	/**
	 * Getting sentence of deleting data from table like "delete from Table where A = 'a', B = 4"
	 *
	 * @param tableName name of the table
	...
	/**
	 * Getting sentence of updating like "update Table set A = 'a', B = 4 where C = 'a' and D = 5"
	 *
	 * @param tableName name of the table
	 * @param update    updating params
	...
	/**
	 * Getting select sentence like "select A, B from Table where C = 'a' and D = 3"
	 *
	 * @param tableName   name of the table
